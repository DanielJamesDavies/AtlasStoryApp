...
export const BiographyClusterItems = ({ biographyCluster, changeBiographyCluster }) => {
	...
	return (
		<EditableContainer
			className='unit-page-subpage-biography-cluster-items-container'
		...
		>
			<div className='unit-page-subpage-biography-cluster-items'>
				{biographyCluster?.items?.map((biographyClusterItem, index) => (
					<div key={index} className='unit-page-subpage-biography-cluster-item-container'>
			...
			<DragDropContainer
				className='unit-page-subpage-biography-cluster-items'
				enableDragDrop={isReorderingBiographyClusterItems}
				onDropItem={reorderBiographyClusterItems}
			>
				{biographyCluster?.items?.map((biographyClusterItem, index) => (
					<DragDropItem key={index} index={index} className='unit-page-subpage-biography-cluster-item-container'>
						<BiographyClusterItem
							biographyCluster={biographyCluster}
							changeBiographyCluster={changeBiographyCluster}
							biographyClusterItem={biographyClusterItem}
