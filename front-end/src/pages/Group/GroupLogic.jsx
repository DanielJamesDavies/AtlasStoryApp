		...
		function getGroupStyle() {
			...
			if (group?.data?.colour) {
				try {
					...
					newGroupStyle["--groupColour"] = colours[0];
					newGroupStyle["--groupColourTint"] = colours[1];
				} catch {
					newGroupStyle["--groupColour"] = group?.data?.colour;
					newGroupStyle["--groupColourTint"] = group?.data?.colour;
				}
			} else {
				newGroupStyle["--groupColour"] = "#0044ff";
				newGroupStyle["--groupColourTint"] = "#0044ff";
			}

			setGroupStyle(newGroupStyle);
		}
