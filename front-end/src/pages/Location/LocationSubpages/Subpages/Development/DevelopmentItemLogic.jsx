...
export const DevelopmentItemLogic = ({ developmentItem, index, locationImagesCurrDevItemIndex, isEditing }) => {
	...
	useEffect(() => {
		...
		function getDevItemImagesContainerClassName() {
			...
			if (locationImagesCurrDevItemIndex === index) newClassName += " location-subpage-development-item-images-container-is-current";
	...
	}, [setDevItemTextContainerClassName, setDevItemImagesContainerClassName, developmentItem, index, locationImagesCurrDevItemIndex, isEditing]);
