...
const CharactersProvider = ({ children, story_uid }) => {
	...
	const curr_story_uid = useRef({ current: false });
	const isGetting = useRef({ characterRelationships: false, charactersCardBackgrounds: false, charactersFaceImages: false });
