...
// Logic
import { CharactersRelationshipsInfoHomeRelationshipTypeItemLogic } from "./CharactersRelationshipsInfoHomeRelationshipTypeItemLogic";
...
// Styles
import "./CharactersRelationshipsInfoHomeRelationshipTypeItem.css";

// Assets

export const CharactersRelationshipsInfoHomeRelationshipTypeItem = ({ relationship, isEditing }) => {
	const { changeRelationshipTypeName, changeRelationshipTypeColour, removeRelationshipType } =
		CharactersRelationshipsInfoHomeRelationshipTypeItemLogic({ relationship });
