...
export const AITools = ({ type, context, isDisplayingButtons }) => {
	const { gpt_messages, onImproveBtnClick, onSummarizeBtnClick, clearGptMessages, onCopyBtnClick } = AIToolsLogic({ type, context });

	return (
		<div className='ai-tools' onClick={(e) => e.stopPropagation()}>
			<div className={isDisplayingButtons ? "ai-tools-buttons ai-tools-buttons-is-displaying" : "ai-tools-buttons"}>
				{!(type === "text") ? null : (
					<IconBtn
