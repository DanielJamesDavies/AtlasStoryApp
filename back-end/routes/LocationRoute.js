...
const CreateLocation = require("../services/Location/CreateLocation");
...
router.post("/", CookieConsentAuthentication, Authenticate, StoryEditAuthentication, CreateLocation);
